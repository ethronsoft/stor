...
namespace esft{
    namespace stor{
        ...
        {
            if (!info.has("version")) throw store_exception{"missing collection version"};
            if (!info.has("name")) throw store_exception{"missing collection name"};
            _version = info["version"].as_int();
        ...
        _name{std::move(o._name)}, _version{o._version},
        _version_increased{o._version_increased},
        _store{o._store}, _db{o._db}, _opt{o._opt},
        _indices{std::move(o._indices)}
        {
            o._version = std::numeric_limits<int>::min();
            o._version_increased = false;
       ...
       collection::~collection(){
        ...
        void collection::persist(){
            if (_store != nullptr && _version_increased){
                _store->put(*this);
                _version_increased = false;
            }
        }
        ...
        bool collection::clear_indices(){
            ...
            if (st.ok()){
                ...
                if (!_version_increased) {
                    _version_increased = true;
                    _version++;
                }
            }
        ...
        std::unordered_set<std::string> collection::process(const eq_instruction &i, const leveldb::ReadOptions &ro) const
        {
        ...
        std::unordered_set<std::string> collection::process(const gt_instruction &i, const leveldb::ReadOptions &ro) const
        {
            std::unordered_set<std::string> res;
        ...
        std::unordered_set<std::string> collection::process(const gte_instruction &i, const leveldb::ReadOptions &ro) const
        {
            std::unordered_set<std::string> res;
        ...
        std::unordered_set<std::string> collection::process(const neq_instruction &i, const leveldb::ReadOptions &ro) const
        {
            std::unordered_set<std::string> res;
        ...
        std::unordered_set<std::string> collection::process(const lt_instruction &i, const leveldb::ReadOptions &ro) const
        {
            std::unordered_set<std::string> res;
        ...
        std::unordered_set<std::string> collection::process(const lte_instruction &i, const leveldb::ReadOptions &ro) const
        {
            std::unordered_set<std::string> res;
